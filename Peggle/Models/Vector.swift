...
struct Vector: Equatable {
    ...
    func subtract(_ vector: Vector) -> Vector {
        return Vector(origin: self.origin, directionX: self.directionX - vector.directionX, directionY: self.directionY - vector.directionY)
    }
    ...
    func getNormalizedPerpendicular() -> Vector {
        ...
        let perpendicularVector = Vector(origin: self.origin, directionX: perpendicularDirectionX, directionY: perpendicularDirectionY)
...
//    }
    ...
    func dotProduct(vector: Vector) -> CGFloat {
        return self.directionX * vector.directionX + self.directionY * vector.directionY
    }
